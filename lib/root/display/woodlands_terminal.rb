    ...
    class WoodlandsTerminal
      ...
      def display
        ...
        [
          ...
          n(8) + bf(7) + vp + f(8) + dd + f(15) + dur(2) + f(12) + ncl(fr[:a]) + f(9) + dd(2) + c(cls[:two])[1] + bf(2),
          n(9) + bf(7) + vp + f(10) + dd + f(4) + c(cls[:ten])[0] + f(24) + c(cls[:two])[2] + bf(2),
          n(10) + bf(7) + vp + f(5) + ncl(fr[:b]) + f(6) + dd(3) + c(cls[:ten])[1] + hp(24) + c(cls[:two])[3] + bf(2),
          ...
          n(14) + bf(2) + c(cls[:nine])[1] + f(11) +  du + f(8) + ddb(2) + f(20) + ncl(fr[:c]) + f(5) + vp + bf(9),
          ...
          n(19) + bf(7) + vp + f(2) + ncl(fr[:d]) + f(3) + dd(2) + c(cls[:twelve])[1] + hp(13) + c(cls[:eleven])[3] + f(6) + c(cls[:six])[2] + bf(3),
          n(20) + bf(7) + vp + f(8) + c(cls[:twelve])[2] + f(13) + c(cls[:eleven])[4] + f(6) + c(cls[:six])[3] + bf(3),
          n(21) + bf(7) + vp + f(3) + fc(fr[:d]) + f(2) + c(cls[:twelve])[3] + dd + f(5) + fc(fr[:f]) + f(5) + dur(2) + f(3) + dd + f(5) + ncl(fr[:g]) + f(4) + c(cls[:six])[4] + bf(3),
          n(22) + bf(7) + vp + f(8) + c(cls[:twelve])[4] + f(2) + dd + f(10) + dub(2) + f(2) + ncl(fr[:f]) + f(2) + dd + f(13) + du + bf(9),
          n(23) + bf(7) + vp + f(6) + du + f(16) + dd + f(7) +  dur(2) + f(7) + dd + f(4) + fc(fr[:g]) + f(4) + du + bf(10),
          n(24) + bf(7) + vp + f(5) + du + f(2) + ncl(fr[:e]) + f(3) + fc(fr[:e]) + f(10) + dd + c(cls[:seven])[0] + f(4) + dd + f(4) + f(5) + du + bf(11),
      ...
      def ncl(clearing, hor=nil)
        l = clearing.priority.to_s.length
        array = (l == 2) ? [] : [hor].compact

        if clearing_options.include?(clearing)
          array << Rainbow(clearing.priority.to_s).orangered.bright
        else
          array << Rainbow(clearing.priority.to_s).cadetblue
        end
      end
      ...
      def c(cl)
        ...
        if cl.priority == 4
          [
            [cor, hor, ncl(cl, hor), hor, hor, hor, hor, hor, hor, dur],
            [ver, dot(8), dur, ver],
          ...
          [
            [cor, hor, ncl(cl, hor), hor, hor, dur, dur, hor, hor, cor],
          ...
          [
            [cor, hor, hor, hor, dur, dur, hor, ncl(cl, hor), hor, cor],
            [ver, dot(2), dur(2), dot(5), ver],
            [dur, dur(2), dot(7), ver],
            [ver, dot(9), ver],
            [cor, hor, hor, hor, hor, hor, hor, hor, hor, hor, cor],
          ...
          [
            [cor, hor, ncl(cl, hor), hor, hor, hor, hor, dur, dur, cor],
          ...
          [
            [cor, hor, ddr, ddr, hor, hor, hor, ncl(cl, hor), hor, cor],
          ...
          [
            [cor, hor, hor, hor, hor, hor, hor, ncl(cl, hor), hor, cor],
            [ver, dot(9), ver],
            [ver, dot(9), ver],
            [ver, dot(9), ver],
            [cor, hor, hor, hor, hor, hor, hor, hor, hor, hor, cor],
      ...
      attr_reader :board, :clearing_options
    end
  end
end
