    ...
    class WoodlandsTerminal
      ...
      def display
        ...
        [
          ...
          n(6) + bf(2) + c(cls[:one])[4] + dd + f(38) + dd + bf(18),
          n(7) + bf(7) + vp + f(6) + dd + f(39) + dd + bf(3) + c(cls[:two])[0] + bf(2),
          n(8) + bf(7) + vp + f(8) + dd + f(39) + dd(2) + c(cls[:two])[1] + bf(2),
          ...
          n(14) + bf(2) + c(cls[:nine])[1] + f(11) +  du + f(24) + f(12) + vp + bf(9),
          n(15) + bf(2) + c(cls[:nine])[2] + f(10) + du + f(24) + f(13) + vp + bf(9),
          ...
          n(21) + bf(7) + vp + f(8) + c(cls[:twelve])[3] + dd + f(18) + dd + f(10) + c(cls[:six])[4] + bf(3),
          n(22) + bf(7) + vp + f(8) + c(cls[:twelve])[4] + f(2) + dd + f(17) +  dd + f(13) + du + bf(9),
          n(23) + bf(7) + vp + f(6) + du + f(16) + dd + f(16) + dd + f(11) + du + bf(10),
          n(24) + bf(7) + vp + f(5) + du + f(19) + dd + c(cls[:seven])[0] + f(4) + dd + f(9) + du + bf(11),
          n(25) + bf(7) + vp + f(4) + du + f(21) + c(cls[:seven])[1] + f(5) + dd + f(7) + du + bf(12),
          n(26) + bf(2) + c(cls[:four])[0] + f(20) + du + c(cls[:seven])[2] + dd + f(5) + dd + f(5) + du + bf(13),
          n(27) + bf(2) + c(cls[:four])[1] + dd + f(6) + c(cls[:eight])[0] + f + du + bf + c(cls[:seven])[3] + bf(2) + dd + f(2) + c(cls[:three])[0] + bf(10),
          n(28) + bf(2) + c(cls[:four])[2] + bf(2) + dd + f(4) + c(cls[:eight])[1] + du + bf(2) + c(cls[:seven])[4] + bf(4) + dd + c(cls[:three])[1] + bf(10),
          n(29) + bf(2) + c(cls[:four])[3] + bf(4) + dd + f(2) + c(cls[:eight])[2] + bf(19) + c(cls[:three])[2] + bf(10),
      ...
      def c(cl)
        ...
        [
          ...
          [ver, dot, dot, dot, dot, dot, dot, dot, dot, dot, ver],
          [ver, dot, dot, dot, dot, dot, dot, dot, dot, dot, ver],
          [ver, dot, dot, dot, dot, dot, dot, dot, dot, dot, ver],
          [cor, hor, hor, hor, hor, hor, hor, hor, hor, hor, cor],
        ]
