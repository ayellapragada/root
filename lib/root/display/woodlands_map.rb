    ...
    class WoodlandsMap
      ...
      def display
        ...
        [
          ...
          n(12) + bf(7) + vp + f(8) + fc(fr[:b]) + f(4) + c(cls[:ten])[3] + f(5) + ncl(fr[:c]) + f(21) + vp + bf(9),
          ...
          n(22) + bf(7) + vp + f(8) + c(cls[:twelve])[4] + f(2) + dd + f(7) + ncl(fr[:f]) + f(2) + dub(2) + f(5) + dd + f(13) + du + bf(9),
          n(23) + bf(7) + vp + f(6) + du + f(8) + ncl(fr[:e]) + f(7) + dd + f(7) +  dur(2) + f(7) + dd + f(4) + fc(fr[:g]) + f(4) + du + bf(10),
